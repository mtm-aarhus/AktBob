...
{
    private readonly SqlDataAccessLoggingDecorator<ITestSqlConnectionFactory> _sut;
    ...
    {
        _sut = new SqlDataAccessLoggingDecorator<ITestSqlConnectionFactory>(_inner, _logger);
    }
