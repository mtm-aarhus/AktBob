...
internal class InvokeWebhookHandlerLogging : IInvokeWebhookHandler
{
    private readonly IInvokeWebhookHandler _inner;
    private readonly ILogger<InvokeWebhookHandler> _logger;

    public InvokeWebhookHandlerLogging(IInvokeWebhookHandler inner, ILogger<InvokeWebhookHandler> logger)
    {
        _inner = inner;
        _logger = logger;
    }
