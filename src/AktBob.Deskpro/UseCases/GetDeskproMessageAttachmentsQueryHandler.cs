...
public class GetDeskproMessageAttachmentsQueryHandler(IDeskproClient deskpro) : IQueryHandler<GetDeskproMessageAttachmentsQuery, Result<IEnumerable<AttachmentDto>>>
{
