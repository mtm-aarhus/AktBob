...
internal class CheckOCRScreeningStatusJobHandler : IJobHandler<CheckOCRScreeningStatusJob>
{
    ...
    public CheckOCRScreeningStatusJobHandler(ILogger<CheckOCRScreeningStatusJobHandler> logger, IData data, IConfiguration configuration, IServiceScopeFactory serviceScopeFactory)
    {
        _logger = logger;
        _data = data;
